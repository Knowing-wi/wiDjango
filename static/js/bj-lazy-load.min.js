...
var BJLL_options = BJLL_options || {}, BJLL = {
    _ticking: !1, check: function () {
        if (!BJLL._ticking) {
            ...
            var e = document.documentElement.clientHeight || body.clientHeight, t = !1,
        ...
        if ("image" == t) null != e.getAttribute("data-lazy-srcset") && e.setAttribute("srcset", e.getAttribute("data-lazy-srcset")), null != e.getAttribute("data-lazy-sizes") && e.setAttribute("sizes", e.getAttribute("data-lazy-sizes")), e.setAttribute("src", e.getAttribute("data-lazy-src")); else if ("iframe" == t) {
